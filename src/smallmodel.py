...
if __name__=='__main__':
    ...
    if train:
        ...
        with open('src/pickles/variables.pkl','wb') as p:
        ...
        with open('src/pickles/token_indices.pkl','wb') as p:
        ...
        model.save('src/s2s.h5')

        encoder_model = Model(encoder_inputs, encoder_states)
        encoder_model.save('src/encoder.h5')
        ...
        decoder_model.save('src/decoder.h5')

        reverse_input_char_index = dict(
            (i, char) for char, i in input_token_index.items())
        reverse_target_char_index = dict(
            (i, char) for char, i in target_token_index.items())
        with open('src/pickles/reverse.pkl','wb') as p:
    ...
    if not train:
        ...
        decoder_model=keras.models.load_model('src/decoder.h5')
